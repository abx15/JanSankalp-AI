              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="p-6 rounded-[2rem] bg-slate-800 hover:bg-slate-700 transition-colors border border-slate-700 text-left group"
                  >
                    <Users className="w-5 h-5 text-blue-400 mb-2 group-hover:scale-110 transition-transform" />
                    <div className="font-bold text-sm">User Registry</div>
                  ...
                  >
                    ...
                    <div className="font-bold text-sm">System Logic</div>
                    <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">
                      Depts & Officers
                    </div>
                  </button>
                  <button className="p-6 rounded-[2rem] bg-slate-800 hover:bg-slate-700 transition-colors border border-slate-700 text-left group">
                  ...
                  <button className="p-6 rounded-[2rem] bg-slate-800 hover:bg-slate-700 transition-colors border border-slate-700 text-left group">
                    ...
                    <div className="font-bold text-sm">Global Matrix</div>
                    <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">
                      Environments
                    </div>
                  </button>
